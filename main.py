...
def main(args):
	...
	# Load dataset
	vocab_generation_file = os.path.join(args.data_path + 'train_all', "data_{}_{}_{}_{}.json".format(args.dataset + '_vocab', args.src_lang,
	...
	if os.path.isfile(vocab_generation_file) and os.path.isfile(train_file) and os.path.isfile(val_file):
		print ("Loading data..")
		dp = DataPreprocessor()
		vocab_dataset, train_dataset, val_dataset, vocabs = dp.load_data(vocab_generation_file, train_file, val_file)
	else:
		print ("Preprocessing data..")
		dp = DataPreprocessor()
		train_dataset, val_dataset, vocabs = dp.preprocess(args.train_path, args.train_path, args.val_path, vocab_generation_file, train_file, val_file,
